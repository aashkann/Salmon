...
namespace Salmon
{
    public class MyComponent1 : GH_Component
    {
        ...
        /// </summary>
        public MyComponent1()
          : base("Flat Surface Divide", "FlatSrfDiv",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Width", "W", "Specify the width of each panel", GH_ParamAccess.item, 1000);
            pManager.AddNumberParameter("Width Spacing", "WS", "Specify the gap between horizontal panels", GH_ParamAccess.item, 200);

            pManager.AddNumberParameter("Height", "H", "Specify the height of each panel", GH_ParamAccess.item, 2000);
            pManager.AddNumberParameter("Height Spacing", "HS", "Specify the gap between vertical panels", GH_ParamAccess.item, 200);
        }
        ...
        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            ...
            //pManager.AddNumberParameter("Console", "Console", "Console", GH_ParamAccess.list);
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.FlatDivideGh;
            }
        }
        ...
        {
            get { return new Guid("96e55c73-4fb5-4b46-af71-73689d1ee292"); }
        }
    }
}